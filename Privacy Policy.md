...
This privacy policy applies to the Next Up app (hereby referred to as "Application") for mobile devices that was created by Mark Howard (hereby referred to as "Service Provider") as an Open Source service. This service is intended for use "AS IS".
